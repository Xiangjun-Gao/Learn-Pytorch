...
def main():
    ...
    writer = SummaryWriter('ResNet_CIFAR')
    net =resnet101()
    net.cuda()
    ...
    for epoch in range(EPOCH):  # loop over the dataset multiple times
        ...
        # 保存每个epoch下的模型参数
        torch.save(net.state_dict(), './ResNet_CIFAR/ResNet_CIFAR_%03d_params.pkl' % (epoch + 1))

    print('Finished Training')
    writer.export_scalars_to_json("./ResNet_MNIST/ResNet_MNIST.json")
    writer.close()
